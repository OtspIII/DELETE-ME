...
public class PlayerScript : MonoBehaviour
{
    ...
    public KeyCode LastKeyHit;
    public int DoingCombo = 0;
    ...
    void Update()
    {
        if (Input.anyKeyDown)
        {
            ...
            {
                LastKeyHit = KeyCode.Z;
                DoingCombo = true;
            }
            else if (Input.GetKeyDown(KeyCode.X) && LastKeyHit == KeyCode.Z && DoingCombo)
            {
                LastKeyHit = KeyCode.X;
            }
            else if (Input.GetKeyDown(KeyCode.C) && LastKeyHit == KeyCode.C && DoingCombo)
            {
                Debug.Log("YOU DID THE COMBO");
            }
            else
            {
                DoingCombo = false;
